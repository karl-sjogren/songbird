    ...
    public partial class AddPlanningEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserScheduless", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserScheduless_PlanningBoards_PlanningBoardId",
                        column: x => x.PlanningBoardId,
                        principalTable: "PlanningBoards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserScheduless_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlannedProjectTime_UserScheduless_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "UserScheduless",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserScheduless_PlanningBoardId",
                table: "UserScheduless",
                column: "PlanningBoardId");

            migrationBuilder.CreateIndex(
                name: "IX_UserScheduless_UserId",
                table: "UserScheduless",
                column: "UserId");
        }
